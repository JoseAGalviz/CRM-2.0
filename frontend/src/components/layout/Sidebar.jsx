    ...
    <>
      ...
      `}>
        ...
        <div className="flex items-center gap-2 px-5 py-4 border-b border-gray-100">
          ...
          <button onClick={onClose} className="ml-auto lg:hidden p-1 rounded text-gray-400 hover:text-gray-600">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {navItems.map(item => (
            ...
            >
              ...
              {item.chatBadge && totalUnread > 0 && (
                <span className="ml-auto w-5 h-5 bg-violet-600 text-white text-xs font-bold rounded-full flex items-center justify-center">
        ...
        <div className="border-t border-gray-100 p-3">
          <NavLink to="/profile" onClick={onClose} className={({ isActive }) => `sidebar-link mb-1 ${isActive ? 'active' : ''}`}>
